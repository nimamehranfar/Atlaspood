...
function DualRoller({CatID, ModelID, SpecialId, ProjectId, EditIndex, PageItem, QueryString, Parameters, PageId}) {
        ...
        return (
            <div className={`w-100 h-100 steps_header ${isCurrentEventKey ? 'steps_header_active' : ''}`}
                ...
                <div className="steps_header_selected_container">
                    ...
                    {/*{showLabels &&*/}
                    {/*    <TruncateMarkup lines={1} tokenize="words" onTruncate={()=>setHeaderTruncated(true)}>*/}
    ...
    function setCart(refIndex, cartValue, delRefs, secondRefIndex, secondCartValue, customAcc) {
        ...
        tempPostObj["SewingOrderDetails"][1]["SewingModelId"] = `${modelID}`;
        ...
        let promise2 = new Promise((resolve, reject) => {
            if (step3 !== "" && !pageLoad && !(motorLoad && refIndex === "MotorType") && refIndex !== "ZipCode") {
                ...
                axios.post(baseURLPrice, tempPostObj)
                    .then((response) => {
                        ...
                        } else if (step2 === "Outside" && step3 === "true") {
                            ...
                            promiseArr2[index] = new Promise((resolve, reject) => {
                                ...
                                if (obj["PreorderText"] === undefined) {
                                    ...
                                    GetUserProjectData(obj).then((temp) => {
                                        ...
                                        tempPostObj["SewingOrderDetails"][1]["CurtainPartId"] = 2302;
                                        tempPostObj["SewingOrderDetails"][1]["SewingModelId"] = tempPostObj["SewingModelId"];
            ...
            promise2.then(() => {
                if (Object.keys(tempFabric).length > 0 || Object.keys(tempFabric2).length > 0) {
                    ...
                    if (temp["Mount"] !== "HiddenMoulding") {
                        if (temp["Headrail"]) {
                            ...
                            if (temp["Headrail"] === "MetalValance") {
                                ...
                                depSetTempArr = new Set([...setGetDeps((temp["MetalValanceColor"] ? "" : "53,"), "5,5Arc", depSetTempArr)]);
                                ...
                                depSetTempArr = new Set([...setGetDeps((temp["MetalValanceColor"] ? "" : "54,"), "5,5Arc", depSetTempArr)]);
                                ...
                                setStepSelectedLabel(tempLabels);
                                setStepSelectedValue(tempValue);
                                depSetTempArr = new Set([...setGetDeps("", "5,5Arc", depSetTempArr)]);
                            } else {
                                ...
                                setStepSelectedLabel(tempLabels);
                                setStepSelectedValue(tempValue);
                                depSetTempArr = new Set([...setGetDeps((temp["RollType"] ? "" : "5A,") + (temp["BracketType"] ? "" : "5B,") + (temp["BracketColor"] ? "" : "5C,"), "5,5Arc", depSetTempArr)]);
                    ...
                    if (temp["Mount"] === "HiddenMoulding") {
                        setTimeout(() => {
                            if (temp["RollType"]) {
                                setStep5Arc(temp["RollType"]);
                                
                                if (temp["RollType"] === "Standard") {
                                    let refIndex = inputs.current["5Arc1"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5Arc1"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5Arc1"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5,5Arc", depSetTempArr)]);
                                } else {
                                    let refIndex = inputs.current["5Arc2"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5Arc2"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5Arc2"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5,5Arc", depSetTempArr)]);
                                }
                            ...
                            if (temp["BracketType"]) {
                                setStep5B(temp["BracketType"]);
                                if (temp["BracketType"] === "Round Edge") {
                                    let refIndex = inputs.current["5AArc1"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5AArc1"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5AArc1"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5B", depSetTempArr)]);
                                } else {
                                    let refIndex = inputs.current["5AArc2"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5AArc2"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5AArc2"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5AArc", depSetTempArr)]);
                                }
                            }
                            if (temp["BracketColor"]) {
                                setStep5AArc(temp["BracketColor"]);
                                if (temp["BracketColor"] === "Satin Brass") {
                                    let refIndex = inputs.current["5BArc1"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5BArc1"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5BArc1"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5BArc", depSetTempArr)]);
                                } else if (temp["BracketColor"] === "Satin Nickel") {
                                    let refIndex = inputs.current["5BArc2"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5BArc2"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5BArc2"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5BArc", depSetTempArr)]);
                                } else {
                                    let refIndex = inputs.current["5BArc3"].getAttribute('ref-num');
                                    tempLabels[refIndex] = inputs.current["5BArc3"].getAttribute('text');
                                    tempValue[refIndex] = inputs.current["5BArc3"].value;
                                    setStepSelectedLabel(tempLabels);
                                    setStepSelectedValue(tempValue);
                                    depSetTempArr = new Set([...setGetDeps("", "5BArc", depSetTempArr)]);
                                }
    ...
    return (
        <div className={`Custom_model_container ${pageLanguage === 'fa' ? "font_farsi" : "font_en"}`}>
                ...
                <div className={`model_customize_section ${pageLanguage === 'fa' ? "font_farsi" : "font_en"}`}>
                    <Accordion ref={accordion} flush activeKey={accordionActiveKey}>
                            ...
                            <Accordion.Collapse eventKey="1">
                                <Card.Body>
                                    <div className="card_body card-body-fabric">
                                        ...
                                        <NextStep currentStep="1" eventKey="15">{t("NEXT STEP")}</NextStep>
                                    </div>
                                </Card.Body>
                            </Accordion.Collapse>
                        </Card>
                                        ...
                                        <div className="help_container">
                                            <div className="help_column help_left_column">
                                                ...
                                                <ul className="help_column_list">
                                                    ...
                                                    <li className="no_listStyle"><b>{t("dk_step2_help_5")}</b>{t("dualroller_step2_help_6")}</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <Card className={step3 === "true" && !!(step2 === "Outside" || step2 === "HiddenMoulding") ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("3")) === -1 && (!accordionActiveKey.startsWith("3")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="3A" stepNum={t("4A")} stepTitle={t("zebra_step3AOutside")} stepRef="3AOut" type="2"
                        ...
                        <Card className={step3 === "true" && !!(step2 === "Outside" || step2 === "HiddenMoulding") ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("3")) === -1 && (!accordionActiveKey.startsWith("3")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="3B" stepNum={t("4B")} stepTitle={t("zebra_step3BOutside")} stepRef="3BOut" type="2"
                        ...
                        <Card className={step3 === "true" && step2 === "Outside" ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("3")) === -1 && (!accordionActiveKey.startsWith("3")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="3C" stepNum={t("4C")} stepTitle={t("zebra_step3COutside")} stepRef="3COut" type="2"
                        ...
                        <Card className={step3 === "true" && step2 === "Outside" ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("3")) === -1 && (!accordionActiveKey.startsWith("3")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="3D" stepNum={t("4D")} stepTitle={t("zebra_step3DOutside")} stepRef="3DOut" type="2"
                                        ...
                                        <div className="box50 radio_style">
                                            <input className="radio" type="radio" text={t("Continuous") + " " + t("Loop")} value="1" name="step4" ref-num="4" id="41"
                                                   ...
                                                   onChange={e => {
                                                       ...
                                                       setDeps("4A1,4A2,4B", "4,41,411,412");
                                        ...
                                        <div className="box50 radio_style">
                                            <input className="radio" type="radio" value="2" name="step4" checked={step4 === "Motorized"}
                                                   ...
                                                   onChange={e => {
                                                       ...
                                                       setCart("", "", "ControlPositionFront,ControlPositionBack,ChainLength");
                                                                                  ...
                                                                                  component={
                                                                                      <div id="popover_content_step5Bhelp1" className="clearfix">
                                                                                          ...
                                                                                          <div className="popover_footer">
                                                                                              ...
                                                                                              <span className="popover_thumbnails">
                                                                                                  <div>
                                                                                                      <img src={require('../Images/drapery/dualRoller/BracketColorRound1.jpg')}
                                                                                                           text="step5B"
                                                                                                           onMouseEnter={(e) => popoverThumbnailHover(e)}
                                                                                                           className="popover_thumbnail_img img-fluid"
                                                                                                           alt=""/>
                                                                                                  ...
                                                                                                  <div>
                                                                                                      <img src={require('../Images/drapery/dualRoller/BracketColorSquare1.jpg')}
                                                                                                           text="step4B"
                                                                                                           onMouseEnter={(e) => popoverThumbnailHover(e)}
                                                                                                           className="popover_thumbnail_img img-fluid"
                                                                                                           alt=""/>
                        ...
                        {/* step 6A */}
                        <Card className={step5 === "Exposed" && step2 !== "HiddenMoulding" ? "" : "noDisplay"}>
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step61"] === undefined ? require('../Images/drapery/roller/RegularRoll1a.jpg') : popoverImages["step61"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step61B"] === undefined ? require('../Images/drapery/roller/ReverseRoll1a.jpg') : popoverImages["step61B"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                        ...
                        <Card className={step5 === "Exposed" && step2 !== "HiddenMoulding" ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("5")) === -1 && (!accordionActiveKey.startsWith("5")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="5C" stepNum={t("6C")} stepTitle={t("roller_step5C")} stepRef="5C" type="1" required={requiredStep["5C"]}
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step63"] === undefined ? require('../Images/drapery/roller/BracketColorRound1.jpg') : popoverImages["step63"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                                                                                              <span
                        ...
                        <Card className={step2 === "HiddenMoulding" ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("5")) === -1 && (!accordionActiveKey.startsWith("5")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="5" stepNum={t("6")} stepTitle={t("roller_step5A")} stepRef="5Arc" type="1" required={requiredStep["5Arc"]}
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step61A"] === undefined ? require('../Images/drapery/roller/RegularRoll1a.jpg') : popoverImages["step61A"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                                                                                              <span className="popover_footer_title">{t("RollType_help_7")}</span>
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step61AA"] === undefined ? require('../Images/drapery/roller/ReverseRoll1a.jpg') : popoverImages["step61AA"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                                                                                              <span className="popover_footer_title">{t("RollType_help_8")}</span>
                        ...
                        <Card className={step2 === "HiddenMoulding" ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("5")) === -1 && (!accordionActiveKey.startsWith("5")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="5A" stepNum={t("6A")} stepTitle={t("roller_step5B")} stepRef="5AArc" type="1" required={requiredStep["5AArc"]}
                        ...
                        <Card className={step2 === "HiddenMoulding" ? "" : "noDisplay"}>
                            <Card.Header className={[...depSet].findIndex(el => el.startsWith("5")) === -1 && (!accordionActiveKey.startsWith("5")) ? "hidden" : ""}>
                                <ContextAwareToggle eventKey="5B" stepNum={t("6B")} stepTitle={t("roller_step5C")} stepRef="5BArc" type="1" required={requiredStep["5BArc"]}
                                                ...
                                                <label className="radio_container">
                                                    <input className="radio" type="radio" text={t("BracketColor3")} value="3" name="step5BArc" ref-num="5BArc" id="5BArc3" outline="true"
                                                           ...
                                                           onChange={e => {
                                                               ...
                                                               setDeps("", "5BArc");
                                                               setCart("BracketColor", "Gun Metal");
                                                           }} ref={ref => (inputs.current["5BArc3"] = ref)}/>
                                                    <div className="frame_img">
                                                        <img src={require('../Images/drapery/roller/GunMetal.jpg')} className="img-fluid bracket_color_img" alt=""/>
                                                    </div>
                                                </label>
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step62A"] === undefined ? require('../Images/drapery/roller/BracketColorRound1.jpg') : popoverImages["step62A"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                                                                                              <span
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step71A"] === undefined ? require('../Images/drapery/roller/SewnIn.jpg') : popoverImages["step71A"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                                                                                              <span
                                                            ...
                                                            {<PopoverStickOnHover placement={`${pageLanguage === 'fa' ? "right" : "left"}`}
                                                                                  ...
                                                                                  component={
                                                                                      <div className="clearfix">
                                                                                          <div className="popover_image clearfix">
                                                                                              <img
                                                                                                  src={popoverImages["step71B"] === undefined ? require('../Images/drapery/roller/designer.jpg') : popoverImages["step71B"]}
                                                                                                  className="img-fluid" alt=""/>
                                                                                          </div>
                                                                                          <div className="popover_footer">
                            ...
                            <Accordion.Collapse eventKey="7">
                                <Card.Body>
                                    <div className="card_body card_body_radio">
                                        ...
                                        <NextStep currentStep="8" eventKey="9">{t("NEXT STEP")}</NextStep>
                                    </div>
                                    <div className=" accordion_help">
                                        <div className=" help_container">
                                            <div className=" help_column help_left_column">
                        ...
                        <Card className={accordionActiveKey === "" ? "card_little_margin" : "card_big_margin"}>
                            <Card.Header>
                                <ContextAwareToggle eventKey="9" stepNum={t("9")} stepTitle={t("zebra_step7")} stepTitle2={t("(Optional)")} stepRef="9" type="2"
                                                    required={requiredStep["9"]}
            ...
            <Modal backdrop="static" keyboard={false} dialogClassName={`measurementsHelp_modal largeSizeModal ${pageLanguage === 'fa' ? "font_farsi" : "font_en"}`}
                ...
                <Modal.Body>
                    <p className="measurementsHelp_modal_title">{t("HOW TO MEASURE FOR DUAL ROLLER SHADES")}</p>
