...
function Zebra({CatID, ModelID, SpecialId, ProjectId, EditIndex, PageItem, QueryString, Parameters, PageId}) {
    ...
    function setDeps(addDeps, removeDeps, currentStep, nextStep) {
        let depSetTempArr = new Set([...depSet]);
        let depSetTempArr2 = new Set([...depSet]);
        ...
        if (removeDeps !== undefined && removeDeps !== "") {
            ...
            tempArr.forEach(dep => {
                if (dep !== undefined && dep !== "") {
                    ...
                    depSetTempArr2 = new Set([...depSetTempArr2].filter(x => x !== dep))
        ...
        //     let tempCheckArr = [...depSetTempArr2].filter(str => str.startsWith(currentStep));
        ...
        if (isLoggedIn) {
            if (currentState === "0") {
                axios.post(baseURLAddSwatch, {}, {
                    ...
                    renderFabrics(response.data ? response.data : {});
                    if (show) {
    ...
    useEffect(() => {
        if (Object.keys(modelAccessories).length > 0 && cartValues["WidthCart"] && cartValues["HeightCart"] && fabricQty > 0) {
            ...
            //     setDeps("411", "");
            // }
            // console.log(modelAccessories, tempStandardPrice, tempSmartPrice);
        }
                                        ...
                                        <div className="box33 radio_style">
                                            ...
                                            <input className="radio" type="radio" text={t("mount_Outside")} value="2" name="step2" ref-num="2" id="22" checked={step2 === "Outside"}
                                                   onChange={e => {
                                                       ...
                                                       setStep21Err3(false);
                                                       if (step3 !== "") {
                                                           setDeps("3AOut,3BOut1,3BOut2,3COut,3DOut", "2,21,3AIn1,3BIn1,3AIn2,3BIn2,3AIn3,3BIn3,3CArc1,3CArc2,3CArc3", "2", "3");
                                                           deleteSpecialSelects();
                                                   ...
                                                   onChange={e => {
                                                       if (step2 === "") {
                                                           ...
                                                           if (step2 === "Inside" && step21 !== "true") {
                                                               ...
                                                               setDeps("3AIn1,3BIn1,3AIn2,3BIn2,3AIn3,3BIn3", "3,3AOut,3BOut1,3BOut2,3COut,3DOut,31,32,3CArc1,3CArc2,3CArc3", "3", "3A");
                                                           ...
                                                           if (step2 === "HiddenMoulding" && step21 !== "true") {
                                                               ...
                                                               selectChanged(e);
                                                               setMeasurementsNextStep("3A");
                                                               setDeps("3AOut,3BOut1,3BOut2,3CArc1,3CArc2,3CArc3", "3,3COut,3DOut,31,32", "3", "3A");
                                                           ...
                                                           selectChanged(e);
                                                           setMeasurementsNextStep("3A");
                                                           setDeps("3AOut,3BOut1,3BOut2,3COut,3DOut", "3,3AIn1,3BIn1,3AIn2,3BIn2,3AIn3,3BIn3,31,32,3CArc1,3CArc2,3CArc3", "3", "3A");
                                        ...
                                        <div className="box50 radio_style">
                                            <input className="radio" type="radio" text={t("Continuous") + " " + t("Loop")} value="1" name="step4" ref-num="4" id="41"
                                                   ...
                                                   onChange={e => {
                                                       ...
                                                       setDeps("4A,4B", "4,41,411,412", "4", "4A");
